...
//SOURCED FROM: http://stackoverflow.com/questions/3756257/absolute-minimum-code-to-get-a-valid-oauth-signature-populated-in-java-or-groovy
/**
 ...
 * 
 */
public class OAuthFor7Dig {

    private static String key = "7d5h5357s8js";
    private static String secret = "rmjewpw52mmjzamf";
    ...
    public static void main(String[] args) throws ClientProtocolException,
        ...
        qparams.add(new BasicNameValuePair("country",
                "CA"));
        //qparams.add(new BasicNameValuePair("oauth_version", "1.0"));

        // generate the oauth_signature
        String signature = getSignature(URLEncoder.encode(
                "http://previews.7digital.com/clip/5703798", ENC),
                URLEncoder.encode(URLEncodedUtils.format(qparams, ENC), ENC));

        // add it to params list
        qparams.add(new BasicNameValuePair("oauth_signature", signature));

        // generate URI which lead to access_token and token_secret. //http://previews.7digital.com/clip/5703798
        URI uri = URIUtils.createURI("http", "previews.7digital.com", -1,
                "/clip/376386",
